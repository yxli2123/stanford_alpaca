python iter_model.py --num_bits 2 --reduced_rank 8 --num_iter 0
python iter_model.py --num_bits 2 --reduced_rank 8 --num_iter 1

python iter_model.py --num_bits 2 --reduced_rank 16 --num_iter 0
python iter_model.py --num_bits 2 --reduced_rank 16 --num_iter 1

python iter_model.py --num_bits 2 --reduced_rank 32 --num_iter 0
python iter_model.py --num_bits 2 --reduced_rank 32 --num_iter 1

python iter_model.py --num_bits 4 --reduced_rank 8 --num_iter 0
python iter_model.py --num_bits 4 --reduced_rank 8 --num_iter 1

python iter_model.py --num_bits 4 --reduced_rank 16 --num_iter 0
python iter_model.py --num_bits 4 --reduced_rank 16 --num_iter 1

python iter_model.py --num_bits 4 --reduced_rank 32 --num_iter 0
